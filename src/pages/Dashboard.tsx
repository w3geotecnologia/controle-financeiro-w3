...
const Dashboard: React.FC = () => {
  ...
  // Operações de contas — utilizado também pelo cadastro por voz
  ...
  // Mesmo comportamento utilizado na página Contas
  ...
  if (isMobile && showMobileMenu) {
    return (
      <MobileMenu
        onViewDashboard={() => setShowMobileMenu(false)}
      />
    );
  }
  ...
  return (
    <AccessControlWrapper>
      <Layout>
        <div className="space-y-2 sm:space-y-6">
          ...
          {isMobile && (
            <div className="flex flex-col gap-2 mb-1">
              ...
              <div className="flex items-center justify-between bg-white rounded-2xl shadow-sm border border-slate-200 px-4 py-3">
                ...
                >
                  <span className="text-2xl font-extrabold tracking-tight">
                    <span style={{ color: '#1a4fa0' }}>FINAN</span>
                    <span style={{ color: '#2a9d8f' }}>TEC</span>
                  </span>
                </button>
              ...
              {/* Botão cadastro por voz — abre o diálogo diretamente */}
              <button
                type="button"
        ...
        {/* =========================================================
            DIÁLOGO DE CADASTRO POR VOZ
            Mesmo componente utilizado na página Contas
           ========================================================= */}
        <VoiceAccountDialog
          isOpen={voiceOpen}
